...
class TelegraphHelper:
    ...
    def _generate_html_header(self, title):
        """Generate a stylish HTML header"""
    ...
    def _generate_image_container(self, image_url, caption=None):
        """Generate styled image container"""
    ...
    def _generate_footer(self):
        ...
        <div style="
            ...
            font-size: 12px;
        ">
            <p>Generated by <a href="{self.author_url}" style="color: #667eea; text-decoration: none;">{self.author_name}</a></p>
    ...
    async def upload_screenshots_from_dir(self, thumbs_dir):
        ...
        th_html += f"""
            <div style="
                ...
                text-align: center;
            ">
                <h3 style="margin: 0; color: #1976d2;">Summary</h3>
    ...
    async def upload_from_pdf(self, pdf_url):
        ...
        th_html += f"""
            <div style="
                ...
                text-align: center;
            ">
                <h3 style="margin: 0; color: #2e7d32;">Document Summary</h3>
                <p style="margin: 5px 0; color: #424242;">
